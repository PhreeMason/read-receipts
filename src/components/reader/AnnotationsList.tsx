...
export const AnnotationsList = forwardRef<Ref, Props>(
    ({ selection, selectedAnnotation, annotations, onClose, deleteAnnotation }, ref) => {
                    ...
                    onRemoveAnnotation={(annotation) => {
                        ...
                        if (annotation.data?.key) {
                            ...
                            withMarkAnnotations.forEach((_annotation) => {
                                ...
                                deleteAnnotation(_annotation.data.key);
                            });
                        } else {
                            removeAnnotation(annotation);
                            annotation.data?.key && deleteAnnotation(annotation.data.key);
                        }
                        onClose();
                    }}
                />
