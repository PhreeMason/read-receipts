...
/**
 * Extracts book data from a Cheerio instance of a Goodreads search results page.
 * @param {CheerioStatic} $ - The Cheerio instance loaded with the HTML of the Goodreads search results page.
